	...
	<header class="header-v2">
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="index.html"><img src="{{ asset('web/images/icons/logo-01.png') }}" alt="IMG-LOGO"></a>
			</div>
		...
		<div class="flex-w flex-c-m">
			<div class="size-202 m-lr-auto respon4">
				...
				<div class="block1 wrap-pic-w">
					<img src="{{ asset('web/images/banner-04.jpg')}}" alt="IMG-BANNER">
			...
			<div class="size-202 m-lr-auto respon4">
				<!-- Block1 -->
				<div class="block1 wrap-pic-w">
					<img src="{{ asset('web/images/banner-05.jpg')}}" alt="IMG-BANNER">
			...
			<div class="size-202 m-lr-auto respon4">
				<!-- Block1 -->
				<div class="block1 wrap-pic-w">
					<img src="{{ asset('web/images/banner-06.jpg')}}" alt="IMG-BANNER">
						...
						<div class="wrap-slick2">
							<div class="slick2">
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="{{ asset('web/images/product-01.jpg')}}" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="{{ asset('web/images/product-02.jpg')}}" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="{{ asset('web/images/product-03.jpg')}}" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="{{ asset('web/images/product-04.jpg')}}" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="{{ asset('web/images/product-05.jpg')}}" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="{{ asset('web/images/product-06.jpg')}}" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="{{ asset('web/images/product-07.jpg')}}" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="{{ asset('web/images/product-08.jpg')}}" alt="IMG-PRODUCT">
										...
										<div class="block2-txt flex-w flex-t p-t-14">
											...
											<div class="block2-txt-child2 flex-r p-t-3">
												<a href="#" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
													<img class="icon-heart1 dis-block trans-04" src="{{ asset('web/images/icons/icon-heart-01.png')}}" alt="ICON">
													<img class="icon-heart2 dis-block trans-04 ab-t-l" src="{{ asset('web/images/icons/icon-heart-02.png')}}" alt="ICON">
												</a>
											</div>
										</div>
									</div>
						...
						<div class="wrap-slick2">
							<div class="slick2">
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="{{ asset('web/images/product-09.jpg')}}" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="{{ asset('web/images/product-10.jpg')}}" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="{{ asset('web/images/product-11.jpg')}}" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="{{ asset('web/images/product-12.jpg')}}" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="{{ asset('web/images/product-13.jpg')}}" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="{{ asset('web/images/product-14.jpg')}}" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="{{ asset('web/images/product-15.jpg')}}" alt="IMG-PRODUCT">
								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											<img src="{{ asset('web/images/product-16.jpg')}}" alt="IMG-PRODUCT">
